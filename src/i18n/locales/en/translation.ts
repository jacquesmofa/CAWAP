export default {
  ...
  hero: {
    ...
    subtitle: 'Building stronger futures through education, advocacy, and community support',
    cta: 'Get Involved',
  ...
  programs: {
    title: 'Our Programs',
    subtitle: 'CAWAP focus on human development and capacity building for the youth, women, seniors for the development of our communities.',
    learnMore: 'Learn More',
    list: {
      youthLeadership: {
  ...
  footer: {
    about: {
      title: 'About CAWAP',
      description: 'Empowering Afro-Caribbean and Canadian women through economic development, advocacy, and community programs.'
    },
    quickLinks: {
      title: 'Quick Links',
      home: 'Home',
    ...
    ourPrograms: {
      ...
      capitalGGirls: 'Capital G-Girls',
      heartWiseSeniors: 'Heart-Wise Seniors',
      womenEmpowerment: 'Women Empowerment',
      javascript: 'JavaScript Program'
    },
    newsletter: {
      title: 'Stay Connected',
      description: 'Subscribe to our newsletter for updates on programs and events.',
    ...
    copyright: 'Canadian and African Women Aid Program (CAWAP). All rights reserved.'
  },
